...
%else
Source:		https://download.qt.io/%{?beta:development}%{!?beta:official}_releases/qt/%(echo %{version}|cut -d. -f1-2)/%{version}%{?beta:-%{beta}}/submodules/qtserialbus-everywhere-src-%{version}%{?beta:-%{beta}}.tar.xz
%endif
...
%global extra_devel_files_SerialBus \
%{_qtdir}/sbom/*
